"""
推断统计分析结果展示 - Kruskal-Wallis检验
"""
import flet as ft
from ui_flet.styles import FLUENT_COLORS, SPACING, FONT_SIZES, COMPONENT_SIZES


class StatisticsResultDisplayInferentialKruskalWallisMixin:
    """推断统计分析Kruskal-Wallis检验结果展示"""

    def _display_kruskal_wallis_result(self, result):
        """显示Kruskal-Wallis检验结果"""
